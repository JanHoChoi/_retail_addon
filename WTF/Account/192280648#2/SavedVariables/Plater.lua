...
PlaterDB = {
	...
	["profiles"] = {
		["Default"] = {
			...
			["ui_parent_scale_tune"] = 1.5599999427795,
			...
			["resources_settings"] = {
				["chr"] = {
					["Player-852-058C64F7"] = "ComboPoints",
					["Player-2133-0E9049A5"] = "SoulShards",
					["Player-2133-0E85E2A6"] = "HolyPower",
				},
			},
			...
			["health_selection_overlay_alpha"] = 0.099999994039536,
			["hook_auto_imported"] = {
				["Reorder Nameplate"] = 4,
				["Dont Have Aura"] = 1,
		...
		["薇羽Anne"] = {
			...
			["aura2_y_offset"] = 0,
			["buffs_on_aura2"] = true,
			["health_selection_overlay"] = "Otravi",
			...
			["hook_data_trash"] = {
				...
				}, -- [1]
				{
					...
					["LastHookEdited"] = "",
					["Hooks"] = {
						["Nameplate Updated"] = "function (self, unitId, unitFrame, envTable, modTable)\n    --insert code here\n    if(unitFrame.namePlateIsTarget) then\n        Plater.SetNameplateColor (unitFrame, \"#006fff\")\n    else\n        Plater.RefreshNameplateColor (unitFrame)\n    end\nend",
					},
					["__TrashAt"] = 1651122903,
					["Time"] = 1651122896,
					["LoadConditions"] = {
						["talent"] = {
						},
					...
					["Options"] = {
						{
							...
							["Key"] = "targetColor",
							["Icon"] = "Interface\\AddOns\\Plater\\images\\option_color",
							["Desc"] = "Color of the targets nameplate",
						}, -- [1]
					},
					["Author"] = "Kalei-Ravenholdt",
					["Desc"] = "Update the health bar color of the current target",
					["Prio"] = 99,
					["version"] = 1,
					["PlaterCore"] = 1,
					["HooksTemp"] = {
			...
			["aura2_x_offset"] = 7,
			["target_indicator"] = "Broken Reversed",
			["saved_cvars"] = {
				["ShowClassColorInNameplate"] = "1",
				["nameplateOverlapV"] = "1.5299999713898",
				["nameplateLargeTopInset"] = "0.085",
				["nameplateShowEnemyMinus"] = "1",
				["NamePlateClassificationScale"] = "1",
				["nameplateShowFriendlyTotems"] = "0",
			...
			["aura_x_offset"] = 0,
			["first_run3"] = true,
			["ui_parent_scale_tune"] = 1.6666666004393,
			...
			["range_check_alpha_friendlies"] = 0.94999998807907,
